      ...
      <div class="accordion-item">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
            ...
            Ottendorf | 01/26 | Gerd Baumann
          </button>
        </h2>
        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
          <div class="accordion-body px-2">

            <label for="worktype-dropdown" class="form-label"> <strong>Arbeitszeit</strong></label>
            ...
            <hr class="mx-3">
            <div class="d-none" id="arbeitsart_2">
              <div class="row mb-2">
                <div class="col-6">
                  <label for="worktype-dropdown" class="form-label"> <strong>Arbeitsart</strong></label>
                  <div class="dropdown" id="worktype-dropdown">
            ...
            <div class="mt-2 mx-3">
              <button class="btn btn-primary" type="button" onclick="show_arbeitsart()">Klicke, um weiter Arbeitsart
                hinzuzufügen</button>
              <script>
                function show_arbeitsart() {
                  document.getElementById("arbeitsart_2").classList.remove("d-none");
                }
              </script>
            </div>
          </div>
      ...
      <div class="accordion-item">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
            ...
            Steinbach am Wald | 02/26 | Max Forstwirt
          </button>
        </h2>
