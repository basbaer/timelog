 <div class="mt-3">
     ...
     <div class="row">
         ...
         <div class="col mt-3 d-flex justify-content-center align-items-center gap-4">
             <a href="{{ route('worker.show', ['worker_id' => $worker_id, 'month' => $previousMonth, 'project' => $selectedProject !== 'all' ? $selectedProject : null]) }}"
             ...
             <a href="{{ route('worker.show', ['worker_id' => $worker_id, 'month' => $nextMonth, 'project' => $selectedProject !== 'all' ? $selectedProject : null]) }}"
         ...
         <div class="col justify-content-end d-flex">
             ...
             @else
                 <a href="{{ route('worker.settings', ['worker_id' => $worker_id]) }}" type="button"
                     class="btn btn-secondary m-3"> {{ __('form.settings') }}</a>
             @endif
         </div>
     </div>
 </div>
